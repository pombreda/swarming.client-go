...
def main():
  ...
  procs = [
    call(['go', 'build'], 'swarming'),
    call(['go', 'build'], 'pkg/swarming'),
#    call(['errcheck'], 'swarming'),
#    call(['errcheck'], 'pkg/common'),
#    call(['errcheck'], 'pkg/swarming'),
    ...
    # David.
    call([sys.executable, THIS_FILE, '--golint'], 'swarming'),
    call([sys.executable, THIS_FILE, '--golint'], 'pkg/common'),
    call([sys.executable, THIS_FILE, '--golint'], 'pkg/swarming'),
    call([sys.executable, THIS_FILE, '--govet'], 'swarming'),
    call([sys.executable, THIS_FILE, '--govet'], 'pkg/common'),
    call([sys.executable, THIS_FILE, '--govet'], 'pkg/swarming'),
  ]
  failed = False
